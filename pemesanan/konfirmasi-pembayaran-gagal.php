                                ...
                                <div class="card" style="border-radius: 15px;">
                                    <div class="card-body text-center">
                                        <div class="mt-3 mb-4" style="margin-left: 10px; margin-right: 10px; ">
                                            <h4 class="mb-2">Oops... Pembayaran Gagal!</h4>
                                        ...
                                        <p class="text-muted mb-4"><span class="mx-2"><a href="../index.php"><button class="btn btn-primary">Coba Pesan Ulang</button></a></span></p>
                                    </div>
                                </div>
